...
const ContactCard = ({
	...
	return (
		<div className='flex flex-col bg-white w-[15rem] slg:w-[18rem] xl:w-[23rem] border-[1px] shadow-md rounded-md py-5 xl:py-10 items-center justify-center text-center gap-2 slg:gap-4 px-4 xl:px-1'>
			{icon}
			...
			<h4 className='text-xs slg:text-sm xl:text-base leading-[180%] text-center'>
				{isLoading && additionalText ? (
					<Skeleton className='h-5 w-20 rounded-sm bg-gray-400 mx-auto animate-pulse' />
				) : type === "tel" ? (
					<>
						<a
